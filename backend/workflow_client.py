...
from agent_gateway import gateway_router
from agent_service import service_agent
from agent_medical import medical_agent
...
def build_client_graph():
    ...
    流程：入口 → gateway_router → service_agent / medical_agent → 结束
    """
